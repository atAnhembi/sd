...
import br.anhembi.spring02.dto.ProdutoDTO;
...
public class ProdutoController {
    ...
    public ResponseEntity<List<Produto>> getProdutoByName(@PathVariable @NotBlank String name) {
    ...
    @PostMapping
    public ResponseEntity<Produto> create(@RequestBody @Valid ProdutoDTO newProduto) {
        // if (newProduto.getCod() != null) {
        //     return ResponseEntity.badRequest().build();
        // }
        Produto produtoInserido = service.create(newProduto.toProduto());
